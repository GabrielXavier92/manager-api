# Migration `20200929102258-init`

This migration has been generated by Gabriel Xavier at 9/29/2020, 10:22:58 AM.
...
+  proceduresGuide ProcedureGuide[]
+  start String
+  comments String?
...
+}
+
+// Foi criado esse relacionamento para que os procedimentos nas guias possam ter seu valor alterado, ou para que no futuro
+// o procedimento na guia seja personalizado
+model ProcedureGuide {
+  id String          @id @default(uuid())
+  account Account @relation(fields: [accountId], references: [id]) // Relacionamento com a conta
+  accountId String // Relacionamento com a conta
+  guide Guide @relation(fields: [guideId], references: [id]) // Relacionamento com a guia
+  guideId String
+  procedure Procedure @relation(fields: [procedureId], references: [id]) // Relacionamento com o procedimento
+  procedureId String
+  name String
+  value String
+  quantity String
...
+  schedules Schedule[] @relation(references: [id]) // Relacionamento com os agendamentos
+  createdAt DateTime @default(now())
+  updatedAt DateTime @updatedAt
+}
+
